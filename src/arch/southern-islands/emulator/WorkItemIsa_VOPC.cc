...
// vcc = !(S0.f < S1.f).
void WorkItem::ISA_V_CMP_NLT_F32_Impl(Instruction *instruction)
{
	Instruction::Register s0;
	Instruction::Register s1;
	Instruction::Register result;
...
// D.u = (S0 < S1)
void WorkItem::ISA_V_CMP_LT_I64_Impl(Instruction *instruction)
{
...
// D.u = (S0 < S1)
void WorkItem::ISA_V_CMP_LT_U64_Impl(Instruction *instruction)
{
	Instruction::Register64 s0, s1;
	Instruction::Register result;
