...
DEFINST(V_CMP_LT_I64,
	"	v_cmp_lt_i64 vcc, %64_SRC0, %64_VSRC1",
	VOPC,
	161,
	4,
	0
...
DEFINST(V_CMP_GE_F32_VOP3a,
	"	v_cmp_ge_f32 %VOP3_64_SVDST, %VOP3_SRC0, %VOP3_SRC1",
	VOP3a,
	6,
	8,
	0
...
DEFINST(V_CMP_NGT_F32_VOP3a,
	"	v_cmp_ngt_f32 %VOP3_64_SVDST, %VOP3_SRC0, %VOP3_SRC1",
	VOP3a,
	11,
	8,
	0
...
DEFINST(V_SUB_I32_VOP3b,
	"	v_sub_i32 %VOP3_VDST, %VOP3_64_SDST, %VOP3_SRC0, %VOP3_SRC1",
	VOP3b,
	294,
	8,
	0
...
DEFINST(V_SUBREV_I32_VOP3b,
	"	v_subrev_i32 %VOP3_VDST, %VOP3_64_SDST, %VOP3_SRC0, %VOP3_SRC1",
	VOP3b,
	295,
	8,
	0
...
DEFINST(DS_WRITE2ST64_B32,
	"	ds_write2st64_b32 %ADDR, %DATA0, %DATA1 %OFFSET0 %OFFSET1",
	DS,
	15,
	8,
	0
...
DEFINST(DS_READ2ST64_B32,
	"	ds_read2st64_b32 %DS_SERIES_VDST, %ADDR %OFFSET0 %OFFSET1",
	DS,
	56,
	8,
	0
...
DEFINST(DS_WRITE_B64,
	"	ds_write_b64 %ADDR, %64_DATA0 %OFFSET10",
	DS,
	77,
	8,
	0
...
DEFINST(DS_READ_B64,
	"	ds_read_b64 %DS_64_VDST, %ADDR %OFFSET10",
	DS,
	118,
	8,
	0
